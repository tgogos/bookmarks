...
- 🎥 [Lessons From Defending The Indefensible](https://www.youtube.com/watch?v=pCVTEx1ouyk) `DoS`, `ACK FLOODS`, `SYN FLOODS`, `BPF`, `INTERRUPT STORMS`, `PARTIAL KERNEL-BYPASS`, `SFLOW`, `BGP NULL-ROUTE`
